 ...
 */
class StatusMonitoringJourney {
    constructor(core) {
        this.core = core;
        this.name = 'StatusMonitoring';
    }
    ...
    async run() {
        ...
        try {
            ...
            this.core.logger.error(`❌ Status monitoring failed: ${error.message}`);
...
module.exports = StatusMonitoringJourney;
