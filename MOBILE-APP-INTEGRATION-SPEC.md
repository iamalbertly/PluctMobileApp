...
**Obtained Via**: `POST /v1/vend-token` (costs 1 credit)

**Characteristics**:
- **Lifetime**: 15 minutes (900 seconds)
- **Scope**: `ttt:transcribe` (automatically set)
- **Cost**: 1 credit deducted from user's balance
...
**When**: User tries to vend token with 0 credits

**Handling**:
```kotlin
if (error.code == "insufficient_credits") {
    val balance = error.details.balance
    showMessage("You need 1 credit to transcribe. Current balance: $balance")
