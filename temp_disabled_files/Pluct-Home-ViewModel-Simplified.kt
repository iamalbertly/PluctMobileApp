...
class PluctHomeViewModelSimplified @Inject constructor(
    ...
    private fun generateJWTOnLaunch() {
        viewModelScope.launch {
            try {
                ...
                // val userJwt = businessEngineClient.generateJWT()
                Log.i("PluctHomeViewModelSimplified", "✅ JWT GENERATED ON LAUNCH")
            } catch (e: Exception) {
    ...
    fun quickScan(url: String, clientRequestId: String) = viewModelScope.launch {
        ...
        try {
            ...
            Log.i("PluctAPIIntegrationService", "✅ JWT GENERATED FOR QUICK SCAN")
