...
object PluctUnifiedErrorHandler {
    ...
    fun handleEngineError(error: EngineError): ErrorInfo {
        return when (error) {
            is EngineError.NetworkError -> ErrorInfo(
                code = "ENGINE_NETWORK",
            ...
            is EngineError.ServiceUnavailable -> ErrorInfo(
                code = "ENGINE_SERVICE_UNAVAILABLE",
                message = "Business Engine service unavailable",
                severity = ErrorSeverity.ERROR,
                category = ErrorCategory.BUSINESS_ENGINE,
            ...
            is EngineError.Timeout -> ErrorInfo(
                code = "ENGINE_TIMEOUT",
                message = "Business Engine request timeout",
                severity = ErrorSeverity.ERROR,
                category = ErrorCategory.BUSINESS_ENGINE,
            ...
            is EngineError.Unknown -> ErrorInfo(
                code = "ENGINE_UNKNOWN",
                message = "Unknown Business Engine error",
                severity = ErrorSeverity.ERROR,
                category = ErrorCategory.BUSINESS_ENGINE,
