...
/**
 * PluctVideoDao - Video data access object
 * NOTE: Interface name kept as PluctVideoDao (not full hierarchical name) due to Room database requirements.
 * Room uses the interface name in the database schema. File follows naming: Pluct-Data-DAO-01Video-01Dao.kt
 * Provides database operations for video items
 * 5 scope layers in file name: Project, Data, DAO, Video, Dao
 */
@Dao
