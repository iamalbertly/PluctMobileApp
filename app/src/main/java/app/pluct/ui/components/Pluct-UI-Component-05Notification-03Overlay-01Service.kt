...
class PluctUIComponent05Notification03Overlay01Service : Service() {
    ...
    /**
     * UX FIX #5: Check if app is in foreground using ProcessLifecycleOwner
    ...
    private fun isAppInForeground(): Boolean {
        return try {
            ...
            Log.d(TAG, "App foreground check via ProcessLifecycleOwner: $isForeground (state=$currentState)")
            isForeground
        } catch (e: Exception) {
